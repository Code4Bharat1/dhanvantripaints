...
export default function Internal_painting() {
  return (
    ...
    <div className="md:flex-row flex-col gap-7 md:gap-7 max-w-7xl relative bg-cover bg-center flex justify-center mx-auto lg:mt-12">
        ...
        <div>
         ...
         <Image
         src="/images/internal2.jpeg"
         alt="internal 2"
         height={500}
         width={350}
         className="md:h-[370px] h-[400px] md:block hidden"
         />

         <div>
        <Image
        src="/images/internal2_copy.jpeg"
        alt="internal 2"
        height={500}
        width={350}
      ...
      <div className="px-1 md:mt-10 w-full max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-start gap-5 md:py-2 md:px-6">
        ...
        <div className="max-w-lg bg-white w-full lg:w-1/2 mt-10 sm:mt-0">
          <h1 className="text-2xl sm:text-3xl font-bold">Internal Painting</h1>
          <p className="mt-4 md:mt-6 md:text-black max-w-[27rem]">
            Give your interiors a fresh and vibrant look with our expert internal
            painting services. We use high-quality paints that provide a smooth,
            long-lasting finish while enhancing the aesthetics of your home or office.
          </p>
        </div>
        <Image
          src="/images/g410.png"
