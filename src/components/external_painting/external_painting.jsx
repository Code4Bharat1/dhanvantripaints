...
export default function External_painting() {
  return (
    <div className="px-6 md:px-11 py-6 flex flex-col items-center mt-5 ">
      {/* Responsive Image Layout */}
       <div className="md:flex-row flex-col gap-7 md:gap-7 max-w-7xl relative bg-cover bg-center flex justify-center mx-auto lg:mt-12">
              <div>
               <Image
               src="/images/external_image_edited.jpeg"
               alt="external 1"
               height={500}
               width={500}
              ...
              <div>
               ...
               <Image
               src="/images/external1.jpeg"
               alt="external 2"
               height={500}
               width={350}
               className="md:h-[370px] h-[200px] md:block hidden"
               />
               <div>
                <Image
                src="/images/external1_mobile.jpeg"
                 alt="external 2"
                 height={500}
                 width={350}
                className="md:h-[370px] h-[250px] md:hidden block"
                 />
                </div>
              </div>
      ...
      <div className="px-1 md:mt-10 w-full max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-start gap-5 md:py-2 md:px-6">
        ...
        <div className="max-w-lg bg-white w-full lg:w-1/2 mt-10 sm:mt-0">
          <h1 className="text-2xl sm:text-3xl font-bold">External Painting</h1>
          <p className="mt-4 md:mt-6 md:text-black max-w-[29rem]">
          Enhance the beauty and durability of your property with our expert external painting services. We use high-quality,
          weather-resistant paints to protect your walls from harsh elements while giving them a fresh, vibrant look.
          Whether it's a residential or commercial space, we ensure a
