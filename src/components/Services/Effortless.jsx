    ...
    return (
        <div className='w-[100%]'>
            ...
            <div className=" flex flex-col md:flex-row md:items-center w-full md:w-fit md:mx-20 pl-0 mt-6 mb-6 md:mt-0 md:mb-0">
                <div className="w-[315px] md:w-[570px] ml-10 md:mr-12 md:ml-auto">
                    <Image
                ...
                <div className="w-full ml-2 md:ml-0 md:w-1/2 px-8 md:px-5 md:mr-5 mr-0 flex flex-col justify-between">
            ...
            <div className=" flex flex-col-reverse md:flex-row md:items-center pr-4 w-full md:w-fit md:mx-20 mt-6 mb-6 md:mt-0 md:mb-0">
                ...
                <div className="w-full md:w-1/2 px-10 ml-0 md:mr-0 md:ml-1 md:px-13 flex flex-col justify-between">
                    <h2 className="text-xl font-semibold mt-4 md:text-2xl">External Painting</h2>
                    <p className=" w-[320px] md:w-full mt-4 text-md md:text-md">
                ...
                <div className=" w-[315px] md:w-1/2 mr-0 md:mr-8 ml-6 md:ml-4">
                    <Image
            ...
            <div className=" flex flex-col md:flex-row items-center w-full md:w-fit md:mx-20 pr-4 pl-0 mt-6 mb-6 md:mt-0 md:mb-0">
                <div className="w-[315px] md:w-1/2  mr-2 md:mr-0 ml-6 md:ml-auto">
                    <Image
                        ...
                        height={600}
                        width={700}
                        className="relative w-full md:h-[350px] h-auto object-cover"
                    />
                </div>
              
                <div className="w-full ml-2 md:w-1/2 px-9 md:px-16 md:ml-0 flex flex-col justify-between">
            ...
            <div className=" flex flex-col-reverse md:flex-row items-center pr-14 w-full md:w-fit md:mx-20 mt-6 mb-6 md:mt-0 md:mb-0">
                ...
                <div className="w-full md:w-1/2 px-10  md:mr-0 md:ml-1 md:px-13 flex flex-col justify-between">
                ...
                <div className=" w-[315px] ml-13 md:ml-7 md:w-1/2">
                    <Image
                        src="/Services/repair_image.jpeg"
                        alt="Repair Painting"
                        height={600}
                        width={700}
                        className="realtive w-full md:h-[350px] h-[200px]  object-cover"
                    />
                </div>
            ...
            <div className=" flex flex-col md:flex-row items-center w-full md:w-fit md:mx-20 mb-15  mt-6 md:mt-0 md:mb-0">
                ...
                <div className="w-full md:w-1/2 px-10 md:px-16  flex flex-col justify-between">
                    ...
                    <p className="w-[315px] md:w-full mt-4 text-md">
